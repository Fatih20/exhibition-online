    ...
    <div className="flex flex-nowrap whitespace-nowrap h-screen items-start justify-start w-screen scrollbar-hide text-white">
      ...
      >
        ...
        <section className="text-sm min-w-[50vw] h-full bg-black whitespace-break-spaces flex flex-col items-center text-white-ivory p-8 font-zmg text-justify">
          ...
          <div className="mt-16 flex ml-24">
            <p className="text-xl mr-8 -ml-8 z-10 font-junicode">(2)</p>
            <p className="font-junicode text-5xl">BERCERITA,</p>
          </div>
        ...
        <section className="text-sm min-w-[25vw] h-full bg-black whitespace-break-spaces flex flex-col items-center text-white-ivory p-8 font-zmg text-justify">
          <p className="mt-16">
            Kemampuan <span className="font-bold">bercerita</span> mengenai
            pengalaman, ilmu, dan isu merupakan kunci untuk membangun koneksi
            dengan sesama.
            <br />
            <br />
        ...
        <section className="text-sm min-w-[25vw] h-full bg-black whitespace-break-spaces flex flex-col items-center text-white-ivory p-8 font-zmg text-justify relative">
          <div className="mt-16 ml-24 flex">
            <p className="text-xl mr-2 font-junicode">(3)</p>
            <p className="font-junicode text-4xl">
