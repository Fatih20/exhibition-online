    ...
    <>
      <div className="flex flex-nowrap whitespace-nowrap h-screen items-start justify-start w-screen scrollbar-hide">
        ...
        >
          ...
          <section className="min-w-[35vw] h-screen bg-red text-white-ivory whitespace-break-spaces flex flex-col items-center gap-4 font-junicode p-8 pt-16">
          ...
          <section className="min-w-[65vw] h-screen bg-white-ivory text-black whitespace-break-spaces flex flex-col gap-4 font-junicode p-8 pt-16">
            ...
            <div className="flex flex-col px-4 py-2 h-1/2 w-2/5">
              ...
              >
                ...
                <label className="mt-4">
                  Tulis komentar, saran, dan kritik kamu mengenai pameran
                </label>
                <textarea
                  rows={4}
                  className="text-black p-2"
